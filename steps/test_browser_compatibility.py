...
scenarios('../features/sanity_prod_customer_all.feature')
...
def login():
    LOGIN_PAGE.enter_username(HD.pearce_username)
    LOGIN_PAGE.enter_password(HD.customer_at_risk_password)
    LOGIN_PAGE.click_login()
    LOGIN_PAGE.retry_if_login_failed_new_ui(DC_URL, HD.pearce_username, HD.customer_at_risk_password)
...
def assert_live_stream():
    # do nothing because pearce customer does not have live video functionality
    pass
...
def click_first_video_name():
    ...
    VIDEO_SEARCH_PAGE.click_second_video_name()
