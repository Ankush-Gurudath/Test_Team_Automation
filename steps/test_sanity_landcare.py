...
scenarios('../features/sanity_prod_landcare.feature')


# LQ-306
@given('the login page is displayed in the browser')
def launch_browser(browser):
    global LOGIN_PAGE, DASHBOARD_PAGE, HD, FLEET_TELEMATICS_PAGE, VIDEO_SEARCH_PAGE, USER_MANAGEMENT_PAGE, FLEET_TELEMATICS_CENTER_PAGE
...
def login():
    ...
    LOGIN_PAGE.enter_username(HD.landcare_username)
    LOGIN_PAGE.enter_password(HD.landcare_password)
...
def verify_safe_driving_report_page():
    ...
    assert_that(FLEET_TELEMATICS_CENTER_PAGE.get_minimum_distance_driven_header_text(), IsEqualIgnoringCase("MINIMUM DISTANCE DRIVEN"))
    assert FLEET_TELEMATICS_CENTER_PAGE.edit_icon_is_displayed() is True
    assert FLEET_TELEMATICS_CENTER_PAGE.invisible_delete_icon_only_root_group_is_displayed() is True
    assert FLEET_TELEMATICS_CENTER_PAGE.delete_icon_is_displayed() is True
...
def verify_left_navigation_in_expand_mode():
    assert DASHBOARD_PAGE.lytx_logo_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.left_navigation_expand_mode_is_displayed() is True
...
def verify_left_navigation_in_collapse_mode():
    assert FLEET_TELEMATICS_PAGE.left_navigation_collapse_mode_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.arrow_right_direction_displayed() is True
...
def verify_all_menus():
    assert FLEET_TELEMATICS_PAGE.dashboard_menu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.map_menu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.productivity_menu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.compliance_menu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.maintenance_menu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.sustainability_menu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.reports_menu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.rulesandexceptions_menu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.messages_menu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.notifications_menu_is_displayed() is True
...
def verify_productivity_sub_menus():
    assert FLEET_TELEMATICS_PAGE.trip_history_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.routes_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.publicworks_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.zones_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.drivercongregation_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.assetlocationsharing_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.linkedassets_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.riskmanagement_submenu_is_displayed() is True
...
def verify_routes_child_menus():
    assert FLEET_TELEMATICS_PAGE.plannedvsactualroutes_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.routesummary_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.unmatchedroute_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.importroutes_subchild_is_displayed() is True


@when('the user clicks the dropdown icon present left to "Public Works" menu')
def click_public_works_dropdown():
    FLEET_TELEMATICS_PAGE.click_publicworks_submenu_dropdown()


@then(
    'the user should see the child menus of Public Works such as Route Completion & Material Management with a vertical line.')
def verify_public_works_sub_menus():
    assert FLEET_TELEMATICS_PAGE.routecompletion_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.materialmanagement_subchild_is_displayed() is True
...
def verify_zones_child_menus():
    assert FLEET_TELEMATICS_PAGE.zones_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.zonevisits_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.zonetypes_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.importzones_subchild_is_displayed() is True
...
def verify_compliance_sub_menus():
    assert FLEET_TELEMATICS_PAGE.hos_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.timecardreport_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.iftareport_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.cleantruckcheck_submenu_is_displayed() is True
...
def verify_hos_child_menus():
    assert FLEET_TELEMATICS_PAGE.logs_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.unidentified_driving_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.violations_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.availability_subchild_is_displayed() is True


@when('the user clicks the dropdown icon present next to "Maintenance" menu')
def click_maintenance_menu_dropdown():
    # Click compliance to close the dropdown and click maintenance dropdown
...
def verify_maintenance_sub_menus():
    assert FLEET_TELEMATICS_PAGE.assetinspection_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.diagnostics_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.maintenance_center_sub_menu_is_displayed() is True


@when('the user clicks the dropdown icon present left to "Maintenance Center" menu')
def click_maintenance_center_drop_down():
    FLEET_TELEMATICS_PAGE.click_maintenance_center_submenu_dropdown()


@then('the user should see the child menus of Diagnostics such as Work Order and Schedules')
def verify_maintenance_center_drop_down():
    assert FLEET_TELEMATICS_PAGE.work_order_sub_child_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.schedules_sub_child_is_displayed() is True


@when('the user clicks the dropdown icon present left to "Diagnostics" menu')
def click_diagnostics_dropdown():
    FLEET_TELEMATICS_PAGE.click_diagnostics_submenu_dropdown()


@then(
    'the user should see the child menus of Diagnostics such as Faults, Measurements, Speed Profile and Log Data and Collisions with a vertical line')
def verify_diagnostics_child_menus():
    assert FLEET_TELEMATICS_PAGE.faults_subchild_xpath_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.measurements_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.speed_profile_subchild_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.log_data_and_collisions_subchild_is_displayed() is True


# LQ-111061
@when('the user clicks the dropdown icon present next to "Sustainability" menu')
def click_sustainability_dropdown():
    # Click maintenance to close the dropdown and click sustainability dropdown
...
def verify_sustainability_sub_menus():
    assert FLEET_TELEMATICS_PAGE.sustainabilitycenter_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.fuel_energy_usage_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.evcharginghistory_submenu_is_displayed() is True
...
def verify_reports_child_menus():
    assert FLEET_TELEMATICS_PAGE.myreports_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.reportsetup_submenu_is_displayed() is True
...
def verify_rules_and_exceptions_child_menus():
    assert FLEET_TELEMATICS_PAGE.rules_submenu_is_displayed() is True
    assert FLEET_TELEMATICS_PAGE.exceptions_submenu_is_displayed() is True
