...
scenarios('../features/pod8_prod_sanity.feature')
...
def login():
    LOGIN_PAGE.enter_username(HD.pod8_full_access_username)
    LOGIN_PAGE.enter_password(HD.password2)
    LOGIN_PAGE.click_login()
    LOGIN_PAGE.retry_if_login_failed_new_ui(WELCOME_URL, HD.pod8_full_access_username, HD.password2)
...
def login_risk_company():
    LOGIN_PAGE.enter_username(RCD.risk_fa_user_pod8)
    LOGIN_PAGE.enter_password(RCD.password)
    LOGIN_PAGE.click_login()
    LOGIN_PAGE.retry_if_login_failed_new_ui(DC_URL, RCD.risk_fa_user_pod8, RCD.password)
