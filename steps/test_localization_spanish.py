...
def verify_login():
    ...
    assert_that(DASHBOARD_PAGE.get_tasks_title(), IsEqualIgnoringCase(LDI.tasks_es_label))
    assert_that(DASHBOARD_PAGE.get_metrics_title(), IsEqualIgnoringCase(LDI.metrics_es_label))
