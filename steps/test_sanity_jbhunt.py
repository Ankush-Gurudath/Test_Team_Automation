...
scenarios('../features/sanity_prod_customer.feature')
...
def login():
    ...
    LOGIN_PAGE.retry_if_login_failed_new_ui(DC_URL, HD.jbhunt_single_company_username, HD.jbhunt_single_company_password)
