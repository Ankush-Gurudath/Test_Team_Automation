...
scenarios('../features/sanity_prod_customer_dvir_only.feature')
...
def login():
    LOGIN_PAGE.enter_username(HD.reyes_username)
    LOGIN_PAGE.enter_password(HD.customer_at_risk_password)
    LOGIN_PAGE.click_login()
    LOGIN_PAGE.retry_if_login_failed_new_ui(DC_URL, HD.reyes_username, HD.customer_at_risk_password)
