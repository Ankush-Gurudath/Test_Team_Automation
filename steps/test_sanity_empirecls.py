...
scenarios('../features/sanity_prod_customer_empirecls.feature')
...
def login():
    ...
    LOGIN_PAGE.select_multi_company("Empire")
    LOGIN_PAGE.click_select_company_button()
    LOGIN_PAGE.retry_if_login_failed_new_ui(DC_URL, HD.geotab_user_name, HD.geotab_password)
...
def click_completed_video_name():
    VIDEO_SEARCH_PAGE.click_reset_button()
    VIDEO_SEARCH_PAGE.click_completed_status_video()
