...
scenarios('../features/pod5_prod_autobots_sanity.feature')


# LQ-306
@given('the login page is displayed in the browser')
def launch_browser(browser):
    global LOGIN_PAGE, DASHBOARD_PAGE, ADD_USER_PAGE, LIBRARY_PAGE, USER_MANAGEMENT_PAGE, DEVICE_MANAGEMENT_PAGE, OPEN_TASKS_REPORT_PAGE, ID, BEHAVIORS_REPORT_PAGE, RECOGNITION_HISTORY_PAGE, DRIVER_VEHICLE_INSPECTION_REPORTS_PAGE, INSPECTION_SCHEDULES_PAGE, INSPECTION_LIST_MANAGEMENT_PAGE, FLEET_TELEMATICS_PAGE, FLEET_TELEMATICS_CENTER_PAGE
...
def login():
    LOGIN_PAGE.enter_username(HD.pod5_autobots_full_access_username)
    LOGIN_PAGE.enter_password(HD.password_single_user)
    LOGIN_PAGE.click_login()
    LOGIN_PAGE.retry_if_login_failed_new_ui(WELCOME_URL, HD.pod5_autobots_full_access_username, HD.password_single_user)
...
def verify_behaviors_by_highest_frequency():
    ...
    # Commented out for now because Autobots Automation doesn't have the enough behaviors yet
...
def go_to_fleet_dashboard(browser):
    global LOGIN_PAGE, DASHBOARD_PAGE, FLEET_MAP_PAGE, LIBRARY_PAGE, FLEET_INSIGHT_PAGE
    ...
    LOGIN_PAGE.enter_username(HD.pod5_autobots_read_only)
    LOGIN_PAGE.enter_password(HD.password_single_user)
    LOGIN_PAGE.click_login()
...
def launch_browser_and_login(browser):
    ...
    LOGIN_PAGE.enter_password(HD.password_single_user)
    LOGIN_PAGE.click_login()
    LOGIN_PAGE.retry_if_login_failed_new_ui(FLEET_URL, HD.pod5_autobots_read_only, HD.password_single_user)
...
def launch_browser(browser):
    global LOGIN_PAGE, VIDEO_SEARCH_PAGE, DASHBOARD_PAGE
    LOGIN_PAGE = LoginPage(browser)
