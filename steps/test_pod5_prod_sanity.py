...
scenarios('../features/pod5_prod_sanity.feature')
...
def login():
    LOGIN_PAGE.enter_username(HD.pod5_beta_full_access_username)
    LOGIN_PAGE.enter_password(HD.password2)
    LOGIN_PAGE.click_login()
    LOGIN_PAGE.retry_if_login_failed_new_ui(WELCOME_URL, HD.pod5_beta_full_access_username, HD.password2)
...
def go_to_fleet_dashboard(browser):
    ...
    LOGIN_PAGE.enter_password(HD.password2)
    LOGIN_PAGE.click_login()
    LOGIN_PAGE.retry_if_login_failed_new_ui(FLEET_URL, HD.pod5_beta_full_access_username, HD.password2)
...
def login_to_video_search():
    ...
    LOGIN_PAGE.enter_password(HD.password2)
    LOGIN_PAGE.click_login()
    LOGIN_PAGE.retry_if_login_failed_new_ui(DC_URL, HD.pod5_beta_full_access_username, HD.password2)
...
def login_risk_company():
    ...
    LOGIN_PAGE.click_login()
    LOGIN_PAGE.retry_if_login_failed_new_ui(WELCOME_URL, RCD.risk_fa_user, RCD.password)
