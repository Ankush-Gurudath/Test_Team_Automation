Feature: DVIR New UI
  ...
  @LQ-173103
  Scenario:To verify the refresh functionality in the DVIR application
    When the user clicks the refresh button in the browser
    Then the user should see the left navigation with the modules

#  Scenario: To verify the browse back functionality in DVIR application
...
#    Then the user be navigated to "DVIR" application again
  ...
  @LQ-169752
  Scenario: To verify the left navigation items present in the DVIR application.
#    When the "Administrator" user is in DVIR application in the new ui shell - the user is already in DVIR tab
#    Then the user should see the new logo "lytx+ GEOTAB"
  ...
  Scenario: Verify the sub-menu's under "List Settings" dropdown
  ...
  @LQ-204424
  Scenario: Navigate to "NEW INSPECTION LIST" page from Vehicle Inspection List page
  ...
  Scenario: Add vehicle inspection List on the Inspection List Management page
    When the user enters required fields: "List Name", "Inspection Item Section" and "Inspection Points" & the user clicks Create
  ...
  @LQ-204429
  Scenario: Navigate to "NEW INSPECTION LIST" page from Trailer Inspection List page
