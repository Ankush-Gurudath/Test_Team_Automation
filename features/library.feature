...
#    Commented because event id is not clickable
...
#  @CIPHER-3785 # commented this test because bug is not fixed yet in stg
#  Scenario: Verify Employee ID is visible next to Driver Name in Coaching History
...
#@NAL-593 --Commenting this test because device is offline -- To be reviewed later
#Scenario: Navigate to video search browse page from events pages
#  When the user clicks more options and the user clicks "Browse"
#  Then the video search browse page is opened

  @LQ-262292
  Scenario: Overlay toggle is disabled and shows tooltip when no ADAS data exists
    ...
    And the user opens the event details page
  ...
  Scenario: Verify tooltip for the overlay toggle button when disabled
  ...
  @LQ-262263
  Scenario: Download options for Following Distance events - Events page
  ...
  @LQ-262287
  Scenario: Verify downloaded file names for all download format types - Events page - MP4 with overlay
    When the user downloads the "MP4 with overlay" file
    Then the downloaded file name should be "<EventID>-overlay.mp4"

  Scenario: Verify downloaded file names for all download format types - Events page - MP4 without overlay
    When the user downloads the "MP4 without overlay" file
    Then the downloaded file name should be "<EventID>.mp4"
#
  Scenario: Verify downloaded file names for all download format types - Events page - DCE
    When the user downloads the "DCE" file
    Then the downloaded file name should be "<EventID>.dce"

  Scenario: Verify downloaded file names for all download format types - Search Event ID - MP4 with overlay
    When search a Following Distance event and downloads the "MP4 with overlay" file
    Then the downloaded file name should be "<EventID>-overlay.mp4"

  Scenario: Verify downloaded file names for all download format types - Search Event ID - MP4 without overlay
    When the user downloads the "MP4 without overlay" file
    Then the downloaded file name should be "<EventID>.mp4"

  Scenario: Verify downloaded file names for all download format types - Search Event ID - DCE
    When the user downloads the "DCE" file
    Then the downloaded file name should be "<EventID>.dce"
#
#  commenting below three tests untill fixes tests data issues
#  Scenario: Verify downloaded file names for all download format types - Coaching History - MP4 with overlay
#    Given user navigates to Coaching History page
#    When search a session id that contains a Following Distance event
#    And the user clicks the event details and downloads the "MP4 with overlay" file
#    Then the downloaded file name should be "<EventID>-overlay.mp4"
#
#  Scenario: Verify downloaded file names for all download format types - Coaching History - MP4 without overlay
#    When the user downloads the "MP4 without overlay" file
#    Then the downloaded file name should be "<EventID>.mp4"
#
#  Scenario: Verify downloaded file names for all download format types - Coaching History - DCE
#    When the user downloads the "DCE" file
#    Then the downloaded file name should be "<EventID>.dce"
