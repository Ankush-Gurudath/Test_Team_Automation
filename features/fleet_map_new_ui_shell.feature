Feature: End to end Fleet Map workflow
  ...
  @LQ-193504
  Scenario: To verify the Collapse icon present in the left navigation panel.
  ...
  Scenario: To verify the Expand icon present in the left navigation panel.
