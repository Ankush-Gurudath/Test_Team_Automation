...
from locators.locators_fleet_telematics_left_panel import LocatorsFleetTelematicsLeftPanel as LF
from pages.base_page import BasePage


class FleetTelematicsPageLeftPanel(BasePage):
    ...
    def more_charts_button_is_displayed(self):
        ...
        return self.wait_for_element_displayed((By.ID, LF.more_charts_button))
    ...
    def click_map_menu(self):
        self.wait_for_element_displayed((By.XPATH, LF.map_menu_xpath))
        self.click((By.XPATH, LF.map_menu_xpath))
        self.wait_for_page_to_fully_load()

    def click_productivity_menu_dropdown(self):
        self.wait_for_element_is_clickable((By.XPATH, LF.productivity_menu_dropdown_xpath))
        self.click((By.XPATH, LF.productivity_menu_dropdown_xpath))
        if not self.trip_history_submenu_is_displayed():
            self.click((By.XPATH, LF.productivity_menu_dropdown_xpath))
    ...
    def click_maintenance_menu_dropdown(self):
        self.click((By.XPATH, LF.maintenance_menu_dropdown_xpath))

    def click_diagnostics_submenu_dropdown(self):
        self.click((By.XPATH, LF.diagnostics_submenu_xpath))

    def click_sustainability_menu(self):
        self.click((By.XPATH, LF.sustainability_menu_xpath))

    def click_sustainability_menu_dropdown(self):
        self.click((By.XPATH, LF.sustainability_menu_dropdown_xpath))
    ...
    def click_reports_menu_dropdown(self):
        self.click((By.XPATH, LF.reports_menu_dropdown_xpath))
    ...
    def click_fleet_settings_submenu(self):
        self.wait_for_element_displayed((By.XPATH, LF.fleet_settings_submenu_xpath))
    ...
    def click_sustainabilityoverview_submenu(self):
        self.click((By.XPATH, LF.sustainabilityoverview_submenu_xpath))
        self.wait_for_page_to_fully_load()
    ...
    def click_search_submenu(self):
        self.click((By.XPATH, LF.search_submenu_xpath))
    ...
    def diagnostics_submenu_is_displayed(self):
        return self.element_is_displayed((By.XPATH, LF.diagnostics_submenu_xpath))
    ...
    def sustainabilityoverview_submenu_is_displayed(self):
        return self.element_is_displayed((By.XPATH, LF.sustainabilityoverview_submenu_xpath))
    ...
    def fleet_settings_submenu_is_displayed(self):
    ...
    def click_addins_menu_dropdown(self):
        self.click((By.XPATH, LF.addins_menu_expand_xpath))

    def addins_menu_expanded_displayed(self):
        return self.element_is_displayed((By.XPATH, LF.addins_menu_expand_xpath))

    def fbt_submenu_is_displayed(self):
        return self.element_is_displayed((By.XPATH, LF.fbt_submenu_xpath))

    def evsa_submenu_is_displayed(self):
        return self.element_is_displayed((By.XPATH, LF.evsa_submenu_xpath))

    def hos_driver_summary_submenu_is_displayed(self):
        return self.element_is_displayed((By.XPATH, LF.hos_driver_summary_submenu_xpath))

    def import_hos_logs_submenu_is_displayed(self):
        return self.element_is_displayed((By.XPATH, LF.import_hos_logs_submenu_xpath))

    def compliance_data_summary_tab_in_map_is_displayed(self):
        if self.element_is_displayed((By.XPATH, LF.map_show_addin_icon_xpath)) is True:
            self.click((By.XPATH, LF.map_show_addin_icon_xpath))
        self.wait_for_element_displayed((By.XPATH, LF.compliance_data_summary_tab_in_map_xpath))
        return self.element_is_displayed((By.XPATH, LF.compliance_data_summary_tab_in_map_xpath))

    def eld_info_config_submenu_is_displayed(self):
        return self.element_is_displayed((By.XPATH, LF.eld_info_config_submenu_xpath))

    def eld_settings_validator_submenu_is_displayed(self):
        return self.element_is_displayed((By.XPATH, LF.eld_settings_validator_submenu_xpath))

    def click_addins_menu(self):
        try:
            self.scroll_page_down()
            self.click((By.XPATH, LF.addins_menu_xpath))
            self.scroll_to_element(self.find((By.XPATH, LF.eld_settings_validator_submenu_xpath)))
        except NoSuchElementException:
            self.click_addins_menu_dropdown()
            self.scroll_page_down()
            self.scroll_to_element(self.find((By.XPATH, LF.eld_settings_validator_submenu_xpath)))
    ...
    def click_fbt_submenu(self):
        self.click((By.XPATH, LF.fbt_submenu_xpath))
        self.wait_for_page_to_fully_load()

    def click_evsa_submenu(self):
        self.click((By.XPATH, LF.evsa_submenu_xpath))
        self.wait_for_page_to_fully_load()

    def click_hos_driver_summary_submenu(self):
        self.click((By.XPATH, LF.hos_driver_summary_submenu_xpath))
        self.wait_for_page_to_fully_load()

    def click_import_hos_logs_submenu(self):
        self.click((By.XPATH, LF.import_hos_logs_submenu_xpath))
        self.wait_for_page_to_fully_load()

    def click_compliance_data_summary_submenu(self):
        self.click((By.XPATH, LF.compliance_data_summary_tab_in_map_xpath))
        self.wait_for_page_to_fully_load()

    def click_eld_info_config_submenu(self):
        self.click((By.XPATH, LF.eld_info_config_submenu_xpath))
        self.wait_for_page_to_fully_load()

    def click_eld_settings_validator_submenu(self):
        self.click((By.XPATH, LF.eld_settings_validator_submenu_xpath))
        self.wait_for_page_to_fully_load()

    def click_holidays_submenu(self):
        self.click((By.XPATH, LF.holidays_submenu_xpath))
        self.wait_for_page_to_fully_load()

    def click_addin_submenu(self, addin_name):
        submenu_map = {
            "fbt": LF.fbt_submenu_xpath,
            "evsa": LF.evsa_submenu_xpath,
            "hos driver summary": LF.hos_driver_summary_submenu_xpath,
            "import hos logs": LF.import_hos_logs_submenu_xpath,
            "compliance data summary": LF.compliance_data_summary_tab_in_map_xpath,
            "eld info config": LF.eld_info_config_submenu_xpath,
            "eld settings validator": LF.eld_settings_validator_submenu_xpath,
        }
        xpath = submenu_map.get(addin_name)
        self.scroll_page_down()
        if xpath:
